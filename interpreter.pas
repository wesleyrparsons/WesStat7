...
begin
  ...
  Case UpCase(WTokenArg[0].S) of
    ...
    'BIVARIATE', 'B', 'BIV': if FoundVar(WTokenArg[1]) and FoundVar(WTokenArg[2]) then begin
      CltScr; writeln('Bivariate Statistics');
      writeln('First Variable ', WData[WTokenArg[1]].Name, ' with ', Length(WData[WTokenArg[1]].Value), ' observations.');
      writeln('Second Variable ', WData[WTokenArg[2].Name, ' with ', Length(WData[WTokenArg[2].Value), ' observations.');
