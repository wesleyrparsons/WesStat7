  ...
  begin
    ...
    case WInput of
      ...
      begin
        ...
        PrintCorrelations(nCol, CData.Value, SData.Value, '1');
      end;
      '2': begin
        for i := 1 to nCol do
        begin
          ...
          begin
            ...
            r := PearsonProductMomentCorrelation(WVector1, WVector2, CovXY, s);
            SetMatrixElement(CData.Value, i, j, r);
            SetMatrixElement(SData.Value, i, j, s.p0);
          end;
        end;
        PrintCorrelations(nCol, CData.Value, SData.Value, '2');
      end;
      '3': begin
        for i := 1 to nCol do
        begin
      ...
      '4': begin
         ...
         begin
           ...
           begin
             GetColumn(WData.Value, j, WVector2);
             r := SpearmanRankCorrelation(WVector1, WVector2, s);
             SetMatrixElement(CData.Value, i, j, r);
             SetMatrixElement(SData.Value, i, j, s.p0);
           end;
         end;
...
{    writeln('Save correlation Data.Value? y/n');
  ...
  var
    ...
    s: SignificanceType;
  begin
    V1 := ReadPositiveInteger('Input number of first variable: ', nCol);
    V2 := ReadPositiveInteger('Input number of second variable: ', nCol);
  ...
  begin
    ...
    readln(V1);
    GetColumn(WData.Value, V1, MData.Value);

    {Measures of Central Tendency and Dispersion}
    AM := ArithmeticMean(MData.Value);
    SD := StandardDeviation(MData.Value);
    Writeln('Basic Statistics');
    writeln('Arithmetic Mean: ', AM: 0: 10);
    writeln('Geometric Mean: ', GeometricMean(MData.Value): 0: 10);
    ...
    writeln('Kurtosis: ', ExcessKurtosis(MData.Value, SD, AM): 0: 5);
    ...
    Writeln('Median: ', q2: 0: 10);
    Writeln('Trimedian: ', Trimedian(MData.Value): 0: 10); // Data.Value have been sorted by Median
    Writeln('Inter-quartile distance: ', InterQuantilDistance(q1, q3): 0: 10);
    Writeln('Mean Absolute Deviation: ', MAD(MData.Value): 0: 10);
    Writeln('Mean Deviation from Mean: ', MeanDeviationFromMean(MData.Value): 0: 10);
    //Writeln('Standard Error of Median: ', StandardErrorOfMedian(MData.Value): 0: 10);
    Writeln('Naive Hodges-Lehmann Estimator: ', NaiveHodgesLehmann(MData.Value): 0: 10);
    Writeln('Hodges-Lehmann Estimator: ', HodgesLehmann(MData.Value): 0: 10);
    // Data.Value have been sorted by Median
    {Writeln('Naive Rousseeuw–Croux Sn Estimator: ', NaiveSn(MData.Value): 0: 10);
    Writeln('Rousseeuw–Croux Sn Estimator: ', Sn(MData.Value): 0: 10);
    Writeln('Naive Rousseeuw–Croux Qn Estimator: ', NaiveQn(MData.Value): 0: 10);
    Writeln('Rousseeuw–Croux Qn Estimator: ', Qn(MData.Value): 0: 10);}
    {Writeln('Rousseeuw-Croux Sn Estimator: ', SnStatistic(MData.Value): 0: 10);
    Writeln('Rousseeuw-Croux Qn Estimator: ', QnStatistic(MData.Value): 0: 10);}
    Writeln('High Median: ', HiMed(MData.Value): 0: 10);
    Writeln('Low Median: ', LoMed(MData.Value): 0: 10);
    Writeln('Trimedian: ', TriMedian(MData.Value): 0: 10);
    Writeln('L-scale (2nd moment): ', Ell2(MData.Value): 0: 10);
    Writeln('L-skewness (3rd moment): ', Ell3(MData.Value): 0: 10);
    Writeln('L-kurtosis (4th moment): ', Ell4(MData.Value): 0: 10);

{FUNCTION Quantile(VAR Data.Value: VectorTyp; q: 0: 10)): 0: 10);

FUNCTION InterQuantilDistance(Q1, Q3: 0: 10)): 0: 10);
    ...
    case WInput of
      '1': begin
        ...
        CreateVector(EV, nCol, 0.0);
            ...
            DestroyVector(EV);
            EVV := DominantEigenValue(WData.Value, EV, EVl);
        end;
